...
%%---Edit_Begin
sigma_x_0=10 % m
sigma_theta_0=30*pi/180 % rad
sigma_dx_0=1 %  m/s
sigma_dtheta_0=1/(delta1^2+delta3^2)^0.5 %angular velocity if at  1m/s the wheel stops abruptly
diag_Sigma_x_0=[sigma_x_0,sigma_theta_0,sigma_dx_0,sigma_dtheta_0]';
%%---Edit_End
